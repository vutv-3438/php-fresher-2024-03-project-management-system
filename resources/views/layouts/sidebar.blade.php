@if(isset($project))
    <aside class="py-12 pl-8 pr-4 sm:pl-6 lg:pl-8 col-md-3 bg-light border me-3 " style="max-width: 20%" )>
                    ...
                    <a href="{{ route('dashboard') }}"
                       class="nav-link py-3 text-dark rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group d-flex">
                        <svg
                            ...
                            viewBox="0 0 22 21">
                            <path
                                d="M16.975 11H10V4.025a1 1 0 0
                                0-1.066-.998 8.5 8.5 0 1 0 9.039
                                9.039.999.999 0 0 0-1-1.066h.002Z"
                            />
                            <path
                                d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0
                                 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51
                                 8.51 0 0 0 12.5 0Z">
                            </path>
                        ...
                        >
                            <svg width="22" height="22" viewBox="0 0 24 24" role="presentation">
                                <g fill="currentColor" fill-rule="evenodd">
                                    ...
                                    13 19 5.009 19 5.009 19 5.002 4.995 5 4.995 5
                                    5.001 5 5 12.991 5 12.991zM3 5.01C3 3.899
                                    3.893 3 4.995 3h14.01C20.107 3 21 3.902 21
                                    5.009v7.982c0 1.11-.893 2.009-1.995 2.009H4.995A2.004
                                    2.004 0 013 12.991V5.01zM19 19c-.005 1.105-.9 2-2.006
                                    2H7.006A2.009 2.009 0 015 19h14zm1-3a2.002 2.002 0
                                    01-1.994 2H5.994A2.003 2.003 0 014 16h16z"
                                        fill-rule="nonzero">

                                    </path>
                                    <path
                                        d="M10.674 11.331c.36.36.941.36 1.3
                                    0l2.758-2.763a.92.92 0 00-1.301-1.298l-2.108
                                    2.11-.755-.754a.92.92 0 00-1.3 1.3l1.406 1.405z">
                                    </path>
                                </g>
                            </svg>
                            <span class="ms-3">{{ __('Issues') }}</span>
                        </a>
                    </li>
                @endcan
                        ...
                        <a href="{{route('workFlows.index', ['projectId' => $project->id])}}"
                           class="nav-link py-3 text-dark rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group d-flex">
                            <svg width="22" height="22" viewBox="0 0 24 24" role="presentation">
                                <g fill="currentColor">
                                    <path
                                        d="M5 19.002C5 19 17 19 17 19v-2.002C17 17 5 17 5
                                    17v2.002zm-2-2.004C3 15.894 3.895 15 4.994
                                    15h12.012c1.101 0 1.994.898 1.994 1.998v2.004A1.997
                                    1.997 0 0117.006 21H4.994A1.998 1.998 0 013 19.002v-2.004z">
                                    </path>
                                    <path d="M5 15h12v-2H5v2zm-2-4h16v6H3v-6z"></path>
                                    <path
                                        d="M7 11.002C7 11 19 11 19 11V8.998C19
                                    9 7 9 7 9v2.002zM5 8.998C5 7.894 5.895
                                    7 6.994 7h12.012C20.107 7 21 7.898 21
                                    8.998v2.004A1.997 1.997 0 0119.006
                                    13H6.994A1.998 1.998 0 015 11.002V8.998z">
                                    </path>
                                    <path
                                        d="M5 5v2h12V5H5zm-2-.002C3 3.894 3.895
                                    3 4.994 3h12.012C18.107 3 19 3.898 19
                                    4.998V9H3V4.998z">
                                    </path>
                                </g>
                            </svg>
                    ...
                    <li class="nav-item">
                        <a href="{{route('issueTypes.index', ['projectId' => $project->id])}}"
                           class="nav-link py-3 text-dark rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group d-flex">
                            ...
                            <span class="ms-3">{{ __('Issue types') }}</span>
                        </a>
                    </li>
                @endcan
                    ...
                    <li class="nav-item">
                        <a href="{{ route('logTimes.index', ['projectId' => $project->id]) }}"
                           class="nav-link py-3 text-dark rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group d-flex">
                            ...
                            <span class="ms-3">{{ __('Spent time') }}</span>
                        </a>
                    </li>
                @endcan
                @can(Action::VIEW_ANY, \App\Models\Member::class)
                    <li class="nav-item">
                        <a href="{{route('members.index', ['projectId' => $project->id])}}"
                           class="nav-link py-3 text-dark rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group d-flex"
                        >
                            <svg width="20"
                                 height="20"
                                 ...
                                 viewBox="0 0 640 512"
                            >
                                <path d="M144 0a80 80 0 1 1 0 160A80 80 0 1 1 144 0zM512 0a80 80
                             0 1 1 0 160A80 80 0 1 1 512 0zM0 298.7C0 239.8 47.8 192 106.7
                             192h42.7c15.9 0 31 3.5 44.6 9.7c-1.3 7.2-1.9 14.7-1.9 22.3c0
                             38.2 16.8 72.5 43.3 96c-.2 0-.4 0-.7 0H21.3C9.6 320 0 310.4 0
                             298.7zM405.3 320c-.2 0-.4 0-.7 0c26.6-23.5 43.3-57.8
                             43.3-96c0-7.6-.7-15-1.9-22.3c13.6-6.3 28.7-9.7 44.6-9.7h42.7C592.2
                             192 640 239.8 640 298.7c0 11.8-9.6 21.3-21.3 21.3H405.3zM224 224a96
                             96 0 1 1 192 0 96 96 0 1 1 -192 0zM128 485.3C128 411.7 187.7 352
                             261.3 352H378.7C452.3 352 512 411.7 512 485.3c0 14.7-11.9 26.7-26.7
                             26.7H154.7c-14.7 0-26.7-11.9-26.7-26.7z"/>
                            </svg>
                            <span class="ms-3">{{ __('Members') }}</span>
                        </a>
                    </li>
                @endcan
            </ul>
